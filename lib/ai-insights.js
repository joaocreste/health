...
function buildModelParams({ record, displayName, currentDate, version }) {
  ...
  return {
    ...
    // truncating the JSON mid-array. 96k (call already streams; Sonnet 5
    // allows 128k streamed): Paulo hit the old 64k cap exactly and lost
    // 8 trailing inline cards to truncation repair.
    max_tokens: 96000,
