...
3. "marker-timeline" — ONE marker across multiple dates.
...
4. "flag-list" — flagged markers (H/HH/L/LL) worth clinical attention.
   { "kind": "flag-list",
     "title": "<short title>",
     "subtitle": "<short context | null>",
...
- Use "narrative" for interpretation; use the structured kinds when the user benefits from seeing the actual numbers in a table.
...
const VALID_KINDS = new Set(["narrative", "panel-snapshot", "marker-timeline", "flag-list"]);
