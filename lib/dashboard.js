 ...
 * Sections: home, physical, mental, spiritual.
 *
 * Each call:
...
const MODEL = "claude-opus-4-8"; // platform-wide "4.8 for everything" (2026-07-21); was claude-sonnet-4-6

export const DASHBOARD_SECTIONS = ["home", "physical", "mental", "spiritual"];
